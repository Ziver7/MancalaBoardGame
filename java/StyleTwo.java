...
public class StyleTwo implements MancalaBoardLayout
{
    ...
    {        
        ...
        mancalaColor = Color.RED;
        mancalaShape = new Rectangle2D.Double(0, 0, mancalaWidth, mancalaWidth);
        
        stoneColor = Color.BLACK;
        stoneShape = new Rectangle2D.Double(0, 0, stoneWidth, stoneHeight);
        
        pitColor = Color.BLUE;
        pitShape = new Rectangle2D.Double(0, 0, pitWidth, pitHeight);
    }
    ...
    {
        Rectangle2D.Double stoneShape = new Rectangle2D.Double(x, y, stoneWidth, stoneHeight);
        return stoneShape;
    }
    ...
    {
        Rectangle2D.Double mancalaPitShape = new Rectangle2D.Double(x, y, mancalaWidth, mancalaHeight);
    ...
    {
        Rectangle2D.Double pitShape = new Rectangle2D.Double(x, y, pitWidth, pitHeight);
        return pitShape;
    }
